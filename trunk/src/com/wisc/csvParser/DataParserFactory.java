...
import com.wisc.csvParser.plugins.CrossbowMoteParser.DataSourceDNRMotes;
...
public class DataParserFactory {
    ...
    public static Hashtable<String,String> getParsers(){
        ...
        parsers.put("Manual Upload", DataParserManualUpload.class.getName());
